...
@Component({
  selector: 'app-highchart-delivertime',
  standalone: true,
  imports: [],
  templateUrl: './highchart-delivertime.component.html',
  styleUrl: './highchart-delivertime.component.css'
})
export class HighchartDelivertimeComponent  implements OnInit {
  ...
  initChart(): void {
    ...
    Highcharts.chart('delivertimecontainer', chartOptions, chartFunction);
  }
}
